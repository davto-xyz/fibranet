  ...
  useEffect(() => {
    ...
    if (savedTasks) {
      ...
      const mockTasks: Task[] = [
        ...
        {
          id: "4",
          title: "Verificación de red",
          address: "Calle Alcalá 120, Madrid",
          status: "pending",
          assignedTo: "2",
          assignedToName: "Lucía Gómez",
          scheduledDate: new Date().toISOString().split("T")[0],
          coordinates: { lat: 40.421, lng: -3.705 },
          startTime: null,
          endTime: null,
          incidents: [],
        },
        {
          ...
          address: "Paseo del Prado 30, Madrid",
          status: "completed",
          assignedTo: "3",
          assignedToName: "Carlos Ruiz",
          scheduledDate: new Date().toISOString().split("T")[0],
          coordinates: { lat: 40.413, lng: -3.692 },
        ...
        {
          id: "6",
          title: "Revisión de empalmes",
          address: "Calle Gran Vía 45, Madrid",
          status: "in-progress",
          assignedTo: "2",
          assignedToName: "Lucía Gómez",
          scheduledDate: new Date().toISOString().split("T")[0],
          coordinates: { lat: 40.419, lng: -3.704 },
